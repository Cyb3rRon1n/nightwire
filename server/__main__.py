...
def build_app():
    ...
    system_prompt = (
        ...
        "block -> tool_call stays null, that's just narration. Example: the player walks "
        "into a room, sits down, or orders a drink -> tool_call stays null, that's ordinary "
        "movement, not combat. If you're not sure violence has actually started, leave "
        "tool_call null - it's never wrong to wait one more turn. Once combat has started, "
